		...
		<div id="content">
			...
			<div class="table-responsive">
				...
				<table class="shop_table beta-shopping-cart-table" cellspacing="0">
                    ...
                    { $n++; 
                        ...
                        $row= $stm->fetch();
                        $thanhtien = $soluong*$row['unit_price'];
                        $tong += $thanhtien;
                    ...
                    ?>
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
								<img src="image/product/<?php echo $row['image'] ?>" alt="" style="width: 80px;height: 60px">
							...
							<td class="product-price">
								<span class="amount"><?php echo $row['unit_price'] ?></span>
							</td>
							...
							<td class="product-quantity">	
                                <form id='frm_<?php echo $id ?>' action=basket.php >
							...
							<td class="product-subtotal">
								<span class="amount"><?php echo number_format($thanhtien); ?>VND</span>
							</td>

							<td class="product-remove">
							<a href="#" onClick="FUpdateGH('<?php echo $id ?>');">Sua</a>
								<a href="basket.php?id=<?php echo $id ?>&action=xoa" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
                    <?php } ?>
					</tbody>
			...
			<div class="cart-collaterals">
				...
				<div class="cart-totals pull-right">
					...
					<div class="cart-totals-row"><span>Cart Subtotal:</span><span><?php echo number_format($tong);echo("vnd"); ?></span></div>
					<div class="cart-totals-row"><span>Shipping:</span><span>Free Shipping</span></div>
					<div class="cart-totals-row"><span>Order Total:</span><span><?php echo number_format($tong);echo("vnd"); ?></span></div>
				</div>
